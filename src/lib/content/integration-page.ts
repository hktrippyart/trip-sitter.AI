...
const zhHant: IntegrationPageContent = {
  ...
  intro: [
    ...
    "然而，好多人喺經歷深層嘅意識探索之後面臨無法言說（Ineffability）嘅困境——巨大嘅情緒、抽象嘅視覺幾何、對宇宙或自我嘅全新頓悟，往往很難用邏輯語言精準描述。創意整合（Creative Integration）將難以言喻嘅精神體驗同深層情緒轉化為藝術過程係溫柔而強大嘅介面，透過繪畫、自由書寫、音樂創作、直覺肢體流動或手作等，將潛意識符號同混亂情緒表達喺創作之中，令瞬間嘅靈感閃現轉化成日常生活嘅療癒養分。",
  ],
  features: [
    {
